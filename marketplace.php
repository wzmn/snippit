    ...
    <div class="relative flex justify-between" id="pin">
        ...
        <div class="flex justify-between flex-col text-container relative">
            <div class="flex flex-col justify-center pr-10 pl-4 panel-text panel-text-1">
                ...
                <p class="text-base md:text-xl font-light">Whether you're looking for lighting products, heat pumps or
            ...
            <div class="flex flex-col justify-center pr-10 pl-4 panel-text">
                ...
                <p class="text-base md:text-xl font-light">With Snippit app, finding quality opportunities has never
            ...
            <div class="flex flex-col justify-center pr-10 pl-4 panel-text">
                ...
                <p class="text-base md:text-xl font-light">Get the full picture with Snippit - Our assessment feature
                    ...
                    <form autocomplete="on" id="register">
                        <div class="flex mb-2">
                            <label class="flex items-center mb-2 py-1 mr-5" for="seller">
                                <input type="radio" class="mr-2" id="seller" value="channel_partner" name="company_type"
                                    checked>
                                <span>Seller</span>
                            </label>
                            <label class="flex items-center mb-2 py-1" for="buyer">
                                <input type="radio" class="mr-2" id="buyer" value="service_provider"
                                    name="company_type">
                                <span>Buyer</span>
                            </label>
                        </div>
...
document.addEventListener("DOMContentLoaded", function() {
    const formState = {
		otpApi: 'http://dev-services.snippit.com.au/api/core/otp',
		otpVerifyApi: 'http://dev-services.snippit.com.au/api/core/otp/verify-otp',
		registerApi: 'http://dev-services.snippit.com.au/api/company/basic/',
        emailOtpSent: !1,
        mobileOtpSent: !1,
        resendCount: 3,
        selectedCountry: "",
