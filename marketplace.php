    ...
    while (have_posts()):
        ...
        ?>
                ...
                .buyers-sellers {
                    ...
                    max-height: calc(var(--phone-max-width) - 273px);
                    opacity: 0;
                    bottom: 170px;
                    position: absolute;
                }
                ...
                .marketplace {
                    ...
                    max-height: calc(var(--phone-max-width) - 257px);
                    opacity: 0;
                    bottom: 220px;
                    position: absolute;
                }
                ...
                @media (max-width: 768px) {
                    ...
                    .buyers-sellers {
                        ...
                        max-height: calc(var(--phone-max-width) - 216px);
                    }
  ...
  -->
      ...
      -->
                ...
                <div class="container mx-auto mb-20 md:mb-40" hero>
                    <div class="banner relative flex justify-center md:min-h-[750px] bg-[#fafafa]">
                        ...
                        <div class="absolute flex items-center text-3xl font-bold bns-text">
                            Sellers
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/marketplace/and.png"
                            class="and-style">
                        ...
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/marketplace/gradient-circle.png"
                            class="absolute gradient">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/marketplace/ss-center.png"
                            class="absolute ss-center">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="581" height="314"
                            viewBox="0 0 581 314" class="left-line">
                            <defs>
                                <linearGradient id="linear-gradient" x1="0.5" x2="0.5" y2="1" gradientUnits="objectBoundingBox">
                                    <stop offset="0" stop-color="#707070" />
                                    <stop offset="1" stop-color="#383838" stop-opacity="0" />
                                </linearGradient>
                                <clipPath id="clip-Snippit_Web_Materials_Marketpalce_st54.335xd_assets-1">
                                    <rect width="581" height="314" />
                                </clipPath>
                            </defs>
                            <g id="Snippit_Web_Materials_Marketpalce_st54.335xd_assets-1"
                                data-name="Snippit_Web Materials_Marketpalce_st54.335xd_assets-1"
                                clip-path="url(#clip-Snippit_Web_Materials_Marketpalce_st54.335xd_assets-1)">
                                <path id="Path_39521" data-name="Path 39521"
                                    d="M543.554,122.986h5.418a1.165,1.165,0,1,0,0-2.329h-5.418c-54.334,0-83.858-25.367-94.03-36.273q-.646-.692-1.269-1.391.7-.636,1.375-1.286a50.162,50.162,0,0,0,7.294-8.8,38.049,38.049,0,0,0,4.278-8.854,26.353,26.353,0,0,0,1.372-8.281c-.037-4.965-1.537-9.213-4.338-12.283a13.647,13.647,0,0,0-9.713-4.521,13.787,13.787,0,0,0-10.313,4.219c-3.111,3.152-4.961,7.755-5.348,13.312-.256,3.661.931,8.267,3.432,13.319a65.973,65.973,0,0,0,8.675,12.939,62.748,62.748,0,0,1-7.014,5.07c-11.478,7.167-32.2,15.21-65.715,12.83C338.61,98.269,299.319,86,255.461,64.179,233.193,53.1,211.508,42.412,191.02,33.39c-22.593-9.949-41.7-17.012-60.121-22.229A286.749,286.749,0,0,0,69.418.5a286.076,286.076,0,0,0-33-.05A331.462,331.462,0,0,0,.975,4.416a1.165,1.165,0,0,0,.38,2.3A309.818,309.818,0,0,1,52,2.415c74.068,0,132.175,28.906,202.423,63.849,23.049,11.466,45.115,20.409,65.584,26.581,18.529,5.587,36.048,9,52.069,10.135a140.059,140.059,0,0,0,39.444-2.335A86.777,86.777,0,0,0,439.19,89.8a65.32,65.32,0,0,0,7.308-5.282q.649.729,1.323,1.451c6.718,7.2,18.569,17.462,36.877,25.427a136.09,136.09,0,0,0,26.7,8.4A159.243,159.243,0,0,0,543.554,122.986ZM448.1,41.292q.176,0,.352.005c5.63.176,11.723,4.786,11.794,14.493.035,4.9-1.839,10.528-5.278,15.855a48.771,48.771,0,0,1-8.241,9.582,63.574,63.574,0,0,1-8.344-12.442c-2.285-4.615-3.42-8.92-3.2-12.123C435.93,46,442.148,41.292,448.1,41.292Z"
                                    fill="url(#linear-gradient)" />
                            </g>
                        </svg>
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="289" height="314"
                            viewBox="0 0 289 314" class="right-line">
                            <defs>
                                <linearGradient id="linear-gradient" x1="0.5" x2="0.5" y2="1" gradientUnits="objectBoundingBox">
                                    <stop offset="0" stop-color="#707070" />
                                    <stop offset="1" stop-color="#383838" stop-opacity="0" />
                                </linearGradient>
                                <clipPath id="clip-Snippit_Web_Materials_Marketpalce_st54.335xd_assets-2">
                                    <rect width="289" height="314" />
                                </clipPath>
                            </defs>
                            <g id="Snippit_Web_Materials_Marketpalce_st54.335xd_assets-2"
                                data-name="Snippit_Web Materials_Marketpalce_st54.335xd_assets-2"
                                clip-path="url(#clip-Snippit_Web_Materials_Marketpalce_st54.335xd_assets-2)">
                                <path id="Path_39520" data-name="Path 39520"
                                    d="M1.023,237.329h17.3c29.53,0,56.874-3.786,81.272-11.253,22.488-6.882,42.277-16.808,58.817-29.5a144.362,144.362,0,0,0,20.953-19.593,125.864,125.864,0,0,0,15.293-21.749,112.124,112.124,0,0,0,9.616-23.1A102.174,102.174,0,0,0,208.2,108.5a112.294,112.294,0,0,0-3.686-34.815,92.612,92.612,0,0,0-12.283-27.2A119.5,119.5,0,0,0,212.575,32.9,192.507,192.507,0,0,0,242.39,1.65,1.023,1.023,0,1,0,240.772.4c-16.117,20.809-32.806,35.711-49.707,44.4a78.741,78.741,0,0,0-7.213-8.8,68.474,68.474,0,0,0-9.262-8.162,56.014,56.014,0,0,0-9.768-5.741,43.519,43.519,0,0,0-9.87-3.179c-6.153-1.16-11.809-.552-16.359,1.759a16.256,16.256,0,0,0-8.407,9.648,15.217,15.217,0,0,0,1.366,11.9c2.276,4.118,6.357,7.541,11.8,9.9a37.575,37.575,0,0,0,8.328,2.468,47.59,47.59,0,0,0,9.868.674,67.389,67.389,0,0,0,23.582-5.455q2.624-1.09,5.259-2.389l.113.167c7.868,11.716,16.97,31.778,15.652,60.823-1.46,32.227-19.315,63.769-48.987,86.539-34.382,26.385-82.393,40.331-138.843,40.331H1.023a1.023,1.023,0,0,0,0,2.046Zm188.19-191.6q-2.43,1.184-4.866,2.2c-8.684,3.608-25.451,8.708-40.18,2.325-11.7-5.067-13.787-13.576-12.024-19.324A14.23,14.23,0,0,1,139.52,22.5c4.143-2.1,9.348-2.648,15.053-1.573C166.926,23.257,179.743,32.466,189.213,45.726Z"
                                    transform="matrix(0.995, 0.105, -0.105, 0.995, -4.572, 27.219)" fill="url(#linear-gradient)" />
                            </g>
                        </svg>
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/marketplace/sellers.png"
                            class="absolute buyers-sellers">
                        <!--svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="289" height="157"
                            viewBox="0 0 289 157" class="buyers-sellers">
                            <defs>
                                <clipPath id="clip-Snippit_Web_Materials_Marketpalce_st54.335xd_assets-5">
                                    <rect width="289" height="157" />
                                </clipPath>
                            </defs>
                            <g id="Snippit_Web_Materials_Marketpalce_st54.335xd_assets-5"
                                data-name="Snippit_Web Materials_Marketpalce_st54.335xd_assets-5"
                                clip-path="url(#clip-Snippit_Web_Materials_Marketpalce_st54.335xd_assets-5)">
                    ...
                    <div class="relative flex justify-between" id="pin">
                            ...
                            <svg id="smiley" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 509.75 536.55">
                                ...
                                <g id="Layer_1-2" data-name="Layer 1">
                                    <g>
                                        ...
                                        <path class="eye-left-0"
                                            d="m125.78,8.78c-8.06-1.75-16.47-.49-23.89,3.12C80.37,22.38,19.8,59.55,8.69,150.08c-13.57,110.49,178.33,93.04,186.08,36.83,7.06-51.19-16.42-166.69-68.99-178.13Z" />
                                        <circle class="pupil-left-0 fill-black" cx="114.91" cy="63.47" r="18.38" />

                                        <path class="eye-right-0"
                                            d="m374.65,8.49c-22.87,2.61-68.88,70.6-55.65,166.03,5,36.06,117.83,82.63,172.9,8.4,7.74-10.43,11.09-23.46,9.44-36.35C495.83,103.49,448.55.04,374.65,8.49Z" />
                        ...
                        <div class="flex justify-between flex-col text-container relative">
                            <div class="flex flex-col justify-center pr-10 pl-4 panel-text panel-text-1">
                                ...
                                <p class="text-base font-light para-width">Whether you're looking for lighting products, heat pumps or
                                    any other energy efficiency upgrade, Snippit has got you covered. So why wait? Start making a
                                    difference for the planet and your business now!</p>
                            </div>
                            <div class="flex flex-col justify-center pr-10 pl-4 panel-text">
                                ...
                                <p class="text-base font-light para-width">With Snippit app, finding quality opportunities has never
                                    been easier. Our certified and validated leads mean less stress for you and more opportunities to
                            ...
                            <div class="flex flex-col justify-center pr-10 pl-4 panel-text">
                                ...
                                <p class="text-base font-light para-width">Get the full picture with Snippit - Our assessment feature
                                    simplifies the process, making it easy for you to make informed decisions with confidence.</p>
                            </div>
                                    ...
                                    <form autocomplete="on" id="register">
                                        <div class="flex mb-2">
                                            <label class="flex items-center mb-2 py-1 mr-5" for="seller">
                                                <input type="radio" class="mr-2" id="seller" value="seller" name="company_type"
                                                    checked>
                                                <span>Seller</span>
                                            </label>
                                        ...
                                        <div class="flex gap-x-4">
                                            <label class="mb-2 flex-1" for="company_owner.first_name">
                                                <div class="mb-3">First Name</div>
                                                <input class="border-shadow mb-2 p-2 w-full" type="text" name="company_owner.first_name" required />
                                            </label>
                                            <label class="mb-2 flex-1" for="company_owner.last_name">
                                                <div class="mb-3">Last Name</div>
                                                <input class="border-shadow p-2 w-full" type="text" name="company_owner.last_name" value=""
                                                    required />
                                            </label>
                                        </div>
                                        <div class="mb-2">
                                            <label class="mb-2" for="company_name">
                                                <div class="mb-3">Company Name</div>
                                                <input class="border-shadow mb-2 p-2 w-full" type="text" name="company_name" required />
                                            </label>
                                        </div>
                                        <div class="flex gap-x-4 mb-2">
                                            <label class="mb-2 w-3/5" for="company_owner.email">
                                                <div class="mb-3">Email ID</div>
                                                <div class="flex">
                                                    <input class="border-shadow mb-2 p-2 w-full" type="email" name="company_owner.email" required />
                                                    <a
                                        ...
                                        <div class="flex gap-x-4 mb-4">
                                            <label class="mb-2 w-3/5" for="company_owner.phone">
                                                ...
                                                <div class="flex">
                                                    ...
                                                    <input class="border-shadow mb-2 p-2 w-full" type="number" id="phone"
                                                        name="company_owner.phone" required />
                                                    <a
                ...
                document.addEventListener("DOMContentLoaded", function() {
                    const formState = {
                        otpApi: 'https://services.snippit.com.au/api/core/otp',
                        otpVerifyApi: 'https://services.snippit.com.au/api/core/otp/verify-otp',
                        registerApi: 'https://services.snippit.com.au/api/company/basic/',
                        emailOtpSent: !1,
                        mobileOtpSent: !1,
                        resendCount: 3,
                        selectedCountry: "",
                    ...
                    function resendTimerMobile() {
                        ...
                        function onClick() {
                            ...
                            //resend otp mobile
                            sendOTP({
                                username: formState.selectedCountry + document.querySelector('input[name="company_owner.phone"]').value
                            }).then(s => {
                                formState.mobileOtpSent = true;
                                addFormError(1,
                                    `OTP has been re-sent to ${formState.selectedCountry} ${document.querySelector('input[name="company_owner.phone"]').value}`
                                );
                            })
                        }
                    ...
                    document.querySelector(".otp-email").addEventListener("click", (s) => {
                        ...
                        //     return;
                        // }
                        if (document.querySelector('input[name="company_owner.email"]').reportValidity()) {
                            // send otp
                    ...
                    document.querySelector(".otp-number").addEventListener("click", (s) => {
                        let element = document.querySelector('input[name="company_owner.phone"]');
                        ...
                        if (element.reportValidity()) {
                            ...
                            sendOTP({
                                ...
                                resendTimerMobile();
                                addFormError(1,
                                    `OTP has been sent to ${formState.selectedCountry} ${document.querySelector('input[name="company_owner.phone"]').value}`
                                );
                            }).catch(err => {
                    ...
                    let error_message = document.forms.register.querySelector(".error-message>.messages");
                    ...
                    document.forms.register.addEventListener("submit", (event) => {
                        ...
                        if (!formState.emailOtpSent && !formState.mobileOtpSent) {
                            addFormError(999, 'You need to enter the OTP sent to your mobile and email');
                            return;
                        }
                        ...
                        fetch(formState.registerApi, {
                            ...
                            data.json().then((res) => {
                                ...
                                if (data.status !== 201) {
                                    ...
                                    if (res.constructor === Object) {
                                        for (err in res) {
                                            if (res[err].constructor === Object) {
                                                for (msg in res[err]) {
                                                    addFormError(msg,
                                                        `Error with <b>${msg.split("_").join(" ")}</b>: ${res[err][msg]}`
                                                        )
                                                }
                                            } else {
                                                addFormError(err,
                                                    `Error with <b>${err.split("_").join(" ")}</b>: ${res[err]}`
                                                    )
                                            }
                                        }
                                    }
                                    ...
                                    addFormError(1,
                                        "Registered sucessfully, <br> please check your e-mail for further instructions."
                                        );
                                    form.reset();
                                }
                            })
                    ...
                    const mobileAnimation = () => {
                        banner.to("[hero] .subtitle", {
                            duration: 0.4,
                            opacity: 1,
                            scale: 1,
                            top: '160px'
                        }, 3)
                        banner.to("[hero] .bns-text", {
                            duration: 0.4,
                            opacity: 1,
                            scale: 1
                        }, 3)
                        banner.to("[hero] .bns-btn", {
                            duration: 0.4,
                            left: "50%",
                            x: '-50%',
                            opacity: 1,
                        ...
                        banner.to(".notification-1", {
                            duration: 0.4,
                            bottom: '140px'
                        })
                        banner.to(".notification-2", {
                            duration: 0.4,
                            bottom: '65px'
                        })
                        banner.to(".notification-3", {
                            duration: 0.4,
                            bottom: '-4px'
                        })
                        banner.to(".buyers-sellers", {
                            duration: 0.4,
                            // bottom: '200px',
                            bottom: '205px',
                            opacity: 1
                        })
                        banner.to(".marketplace", {
                            duration: 0.4,
                            bottom: '320px',
                            opacity: 1,
                            marginLeft: '-22px'
